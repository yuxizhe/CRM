...
module.exports = (app) => {
  ...
  if (isMock) {
    ...
    // 用户查询接口
    router.get('/xq/report/permission/user/get/all.json', (ctx) => {
      resjson(ctx, {
        data: [{
          user_id: 1,
          name: 'aaa',
    ...
    // 权限分类接口
    router.get('/xq/report/permission/role/get/all.json', (ctx) => {
      resjson(ctx, {
        data: [{
          role_id: 1,
          name: 'admin',
    ...
    // 获取角色权限
    router.get('/xq/report/permission/role/get/resources.json', (ctx) => {
      resjson(ctx, {
        data: [{
          resource_id: 1,
          resource_pid: 0,
